...
public sealed record ProductResourceTemplateDto(Guid Id, string Name, Guid ResourceTypeId, string ResourceTypeName, bool IsRequired, bool CanBeShared, int SortOrder);
